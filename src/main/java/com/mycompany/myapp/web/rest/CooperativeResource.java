    ...
    public ResponseEntity<Cooperative> partialUpdateCooperative(
        ...
        Optional<Cooperative> result = cooperativeRepository
            ...
            .map(existingCooperative -> {
                if (cooperative.getCity() != null) {
                    existingCooperative.setCity(cooperative.getCity());
                }
                if (cooperative.getNumberOfShop() != null) {
                    existingCooperative.setNumberOfShop(cooperative.getNumberOfShop());
                }
