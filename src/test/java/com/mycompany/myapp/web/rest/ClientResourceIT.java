...
class ClientResourceIT {
    ...
    private static final Integer DEFAULT_ORDER_COUNT = 1;
    private static final Integer UPDATED_ORDER_COUNT = 2;
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().balance(DEFAULT_BALANCE).orderCount(DEFAULT_ORDER_COUNT);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().balance(UPDATED_BALANCE).orderCount(UPDATED_ORDER_COUNT);
        return client;
    }
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getOrderCount()).isEqualTo(DEFAULT_ORDER_COUNT);
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.balance(UPDATED_BALANCE).orderCount(UPDATED_ORDER_COUNT);
        ...
        assertThat(testClient.getOrderCount()).isEqualTo(UPDATED_ORDER_COUNT);
    }
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.balance(UPDATED_BALANCE).orderCount(UPDATED_ORDER_COUNT);
