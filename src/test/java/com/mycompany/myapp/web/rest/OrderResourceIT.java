...
class OrderResourceIT {
    ...
    private static final String DEFAULT_TAKEOUT_ADRESS = "AAAAAAAAAA";
    private static final String UPDATED_TAKEOUT_ADRESS = "BBBBBBBBBB";
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().deliveryAddress(DEFAULT_DELIVERY_ADDRESS).takeoutAdress(DEFAULT_TAKEOUT_ADRESS);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().deliveryAddress(UPDATED_DELIVERY_ADDRESS).takeoutAdress(UPDATED_TAKEOUT_ADRESS);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getTakeoutAdress()).isEqualTo(DEFAULT_TAKEOUT_ADRESS);
    }
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].takeoutAdress").value(hasItem(DEFAULT_TAKEOUT_ADRESS)));
    }
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.takeoutAdress").value(DEFAULT_TAKEOUT_ADRESS));
    }
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.deliveryAddress(UPDATED_DELIVERY_ADDRESS).takeoutAdress(UPDATED_TAKEOUT_ADRESS);
        ...
        assertThat(testOrder.getTakeoutAdress()).isEqualTo(UPDATED_TAKEOUT_ADRESS);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.deliveryAddress(UPDATED_DELIVERY_ADDRESS);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.deliveryAddress(UPDATED_DELIVERY_ADDRESS).takeoutAdress(UPDATED_TAKEOUT_ADRESS);
