...
class PaymentResourceIT {
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment().paymentMethod(DEFAULT_PAYMENT_METHOD).amount(DEFAULT_AMOUNT);
        return payment;
    }
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment().paymentMethod(UPDATED_PAYMENT_METHOD).amount(UPDATED_AMOUNT);
        return payment;
    }
    ...
    void putNewPayment() throws Exception {
        ...
        updatedPayment.paymentMethod(UPDATED_PAYMENT_METHOD).amount(UPDATED_AMOUNT);
    ...
    void fullUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.paymentMethod(UPDATED_PAYMENT_METHOD).amount(UPDATED_AMOUNT);
